        ...
        <div class="row">
          <div class="col-md-7 d-none d-md-block">
            <div class="account-cover d-flex justify-content-center align-items-center">
              <img src="{{ URL::asset('sources/images/login.png') }}" id="login-cover">
              <img src="{{ URL::asset('sources/images/register.png') }}" id="register-cover" style="display: none">
            </div>
          </div>
            ...
            <form class="form" method="POST" action="{{ route('bongden_register') }}">
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-8">
                    <input id="register-name" type="text" placeholder="Họ Tên" name="username" required>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                <input type="radio" name="sex" id="male-radio" value="male" checked>
                <input type="radio" name="sex" id="female-radio" value="female">
                <div class="sex-grid">
