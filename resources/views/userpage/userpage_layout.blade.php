    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Mục khám phá:</h6>
            <a class="collapse-item" href="utilities-color.html">Tạo từ khóa</a>
            <a class="collapse-item" href="utilities-border.html">Mục What-IF</a>
            <a class="collapse-item" href="utilities-animation.html">Tìm hiểu chuyên mục</a>
          </div>
        </div>
      </li>
