          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow mx-1">
              <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <!-- Counter - Alerts -->
                <span class="badge badge-danger badge-counter" id="alert_count">{{ count(Auth::user()->notifies) }}+</span>
              </a>
              <!-- Dropdown - Alerts -->
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                ...
                <div id="drop-alert">
                  @foreach(Auth::user()->notifies as $key => $notify)
                  @if($key <= 6)
                  ...
                  <a class="dropdown-item d-flex align-items-center" href="#">
                    ...
                    <div>
                      <div class="small text-gray-500">{{ App\Http\Services\TimeService::timeAsString($notify->created_at) }}</div>
                      <span class="font-weight-bold">{{ json_decode($notify->content_as_json,true)["title"] }}</span>
                    </div>
                  </a>
                  @endif
                  @endif
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="{{ route('bongden_logout') }}">Logout</a>
        </div>
      </div>
    </div>
  </div>
